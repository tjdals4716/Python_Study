...
import xlsxwriter
window = Tk()
photo = PhotoImage(file = '/Users/thdtjdals__/Desktop/데이터 분석 2일차 자료/GIF2/picture06.gif')
h = photo.height()
w = photo.width()
...
workbook = xlsxwriter.Workbook('/Users/thdtjdals__/Desktop/데이터 분석 2일차 자료/Excel/picture06_art.xlsx')
